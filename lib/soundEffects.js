...
const FILES = {
  ...
  lose: 'u_ss015dykrt-timpani-boing-fail-146292.mp3',
  buttonClick: '536788__egomassive__flop.ogg',
  playMatched: '710378__kevp888__cd_vie_007fx_gong_1.wav',
};
...
export function playPlayMatchedSound() {
  fireOverlap(FILES.playMatched);
}
